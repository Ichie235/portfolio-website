...
export const blogData: BlogWebsiteProps[] = [
  {
    id: "1",
    paragraph1:
      "ICHIE-BLOGGING-API is a dynamic Node.js web application. With its seamless integration of CRUD functionalities, JWT web token authentication, and MongoDB database setup, it offers users a robust   platform to create, share, and explore captivating blog content   ",
    paragraph2: "",
    CRUD: "ICHIE-BLOGGING-API empowers users with full control over their content through Create, Read, and Search operations. It allows, users can effortlessly manage their blog entries.",
